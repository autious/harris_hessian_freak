...
__kernel void derivate_y( __global float* input, __global float* ddy, int width, int height )
{
    int x = get_global_id(0);
    int y = get_global_id(1);
    float v0, v1;
...
__kernel void derivate_x( __global float* input, __global float* ddx, int width, int height )
{
    int x = get_global_id(0);
    int y = get_global_id(1);
    float v0, v1;
