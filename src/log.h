...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "opencl_app", __VA_ARGS__))
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "opencl_app", __VA_ARGS__))
